(ns og.clj-cayley-dickson.graphics.colors)

;credit to: https://github.com/clojure-numerics/image-matrix/blob/master/src/main/clojure/mikera/image_matrix/colours.clj
